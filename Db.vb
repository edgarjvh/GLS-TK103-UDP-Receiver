...
Public Class Db
    ...
    Private Const str As String = "server=localhost;uid=glsuser;pwd=glspass;database=glsdb;Convert Zero Datetime=True"
    Private Const strDemo As String = "server=localhost;uid=vtdemouser;pwd=vtdemopass;database=vtdemodb;Convert Zero Datetime=True"
    ...
    Public Sub insertTrace(ByVal imei As String, ByVal event_name As String, ByVal date_time As String,
                           ...
                           ByVal orientation As Integer, ByVal ip As String, ByVal port As Integer, ByVal IsTransmittingDemo As Boolean)
        ...
        Try
            ...
            If IsTransmittingDemo Then
                Using conn As New MySqlConnection(strDemo)
                    conn.Open()
    ...
    Public Sub insertTrace(ByVal trace As String, ByVal ip As String, ByVal port As Integer, ByVal date_time As String, ByVal IsTransmittingDemo As Boolean)
        Try
            Using conn As New MySqlConnection(str)
                conn.Open()
